                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                final currentCityId = currentCities.values
                                    .toList()[index]['cityId'];
                                final currentCityName = currentCities.values
                                    .toList()[index]['cityName'];
                                final currentCityLatitude = currentCities.values
                                    .toList()[index]['cityLatitude'];
                                final currentCityLongitude =
                                    currentCities.values.toList()[index]
                                        ['cityLongitude'];
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    locationProvider.changeCity({
                                      currentCityId: {
                                        ...
                                        'cityLatitude': currentCityLatitude,
                                        'cityLongitude': currentCityLongitude,
                                      },
                                    });
                                    Navigator.of(context).pop();
                                    Navigator.of(context).pop();
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: darkGrey.withOpacity(0.25),
                                      borderRadius: BorderRadius.circular(4),
                                      border: cityName != currentCityName
                                          ? null
                                          : Border.all(
                                              width: 3,
                                              color: darkGrey,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        SizedBox(
                                          width: cityName != currentCityName
                                              ? width * 0.875
                                              : width * 0.75,
                                          child: Text(
                                            currentCityName,
